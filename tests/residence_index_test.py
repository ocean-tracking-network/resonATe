...
class ResidenceIndexTest(unittest.TestCase):
    ...
    def test_kessel(self):
        ...
        dfa = ri.residency_index(pd.read_csv('tests/assertion_files/nsbs.csv'), calculation_method='kessel')
    ...
    def test_timedelta(self):
        ...
        dfa = ri.residency_index(pd.read_csv('tests/assertion_files/nsbs.csv'), calculation_method='timedelta')
    ...
    def test_aggregate_with_overlap(self):
        ...
        dfa = ri.residency_index(pd.read_csv('tests/assertion_files/nsbs.csv'), calculation_method='aggregate_with_overlap')
    ...
    def test_aggregate_no_overlap(self):
        ...
        dfa = ri.residency_index(pd.read_csv('tests/assertion_files/nsbs.csv'), calculation_method='aggregate_no_overlap')
