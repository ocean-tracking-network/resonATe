...
distance_matrix_input <- 'sample_distance_matrix_v00.csv' # first file will be the full file
distance_real_input <- 'sample_distance_matrix_v01.csv' # second file is a set of distances which are to be used to override the distances on the first file
